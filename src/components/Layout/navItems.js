import { HomeSVGIcon, TvSVGIcon, Filter6SVGIcon, PagesSVGIcon, ListSVGIcon } from 'react-md';
...
const navItems = {
  ...
  'page with props': createRoute('/page-with-prop', 'Page with prop', <PagesSVGIcon />),
